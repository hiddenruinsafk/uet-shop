  ...
  return (
    <div style={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg)" }}>
      <div className="sc" style={{ background: "var(--surface)", padding: 40, width: "90%", maxWidth: 340, borderRadius: 4, boxShadow: "var(--shadow-lg)" }}>
        ...
        <img src={LOGO} alt="Logo" style={{ height: 45, objectFit: "contain", display: "block", margin: "0 auto 30px" }} />
...
export default function App() {
  ...
  if (loading) return (<><style dangerouslySetInnerHTML={{__html:CSS}}/><div style={{height:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:22,background:"var(--bg)"}}><img src={LOGO} alt="Logo" style={{ height: 42, objectFit: "contain" }} /><Spin size={20}/></div></>);
